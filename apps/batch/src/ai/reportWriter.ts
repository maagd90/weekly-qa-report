...
function reportPrompt(reportType: ReportType, filter: FilterParams, metricsJson: string): string {
  ...
  return [
    ...
    '',
    'Write exactly this style:',
    '- 2 to 4 short paragraphs written like a QA manager update.',
    '- One short bullet list titled **Recommended follow-up**.',
    ...
    '- State what the execution, defect, cycle, and UAT metrics mean for sprint health.',
    '- Highlight risks only when supported by failed, blocked, open, at-risk, or low-coverage metrics.',
