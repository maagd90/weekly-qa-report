...
export function QaFilterBar(props: QaFilterBarProps) {
  ...
  return (
    <form
      ...
      className="max-w-qa mx-auto px-4 py-3.5 flex min-w-0 flex-col items-stretch gap-3 border-b border-[#e7e3d9] sm:px-6 lg:px-8 lg:flex-row lg:items-center lg:flex-wrap lg:gap-[18px] print:hidden"
    >
      <div className="grid w-full min-w-0 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 sm:grid-cols-[auto_minmax(0,1fr)_auto_minmax(0,1fr)_auto] lg:w-auto">
        ...
        {onSearchApis && (
          <button
            ...
            title="Apply the selected period and search to the current tab"
