    ...
    <div className="border border-qa-border bg-[#faf8f2] p-3.5 mb-3">
      <div className="mb-3 border border-qa-border bg-white px-3 py-2">
        ...
        <p className="text-[11px] text-qa-muted m-0 mt-2">
          {isCloud ? 'Cloud uses Jira REST API v3 with email + API token.' : 'On-premises uses Jira REST API v2 with bearer/token authentication by default.'}
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 mt-2.5">
        <button type="button" onClick={() => testMutation.mutate()} disabled={testMutation.isPending} className="font-mono-qa text-[10px] font-semibold tracking-wider uppercase px-3 py-1.5 border border-qa-border bg-white cursor-pointer disabled:opacity-50">
    ...
    <QaPageShell title="Settings" intro="Configure the global LLM provider, report branding, and your project-specific JIRA/QMetry integrations. Select a project in the dashboard filter to view only that project's live or uploaded data.">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[22px]">
        ...
        <QaSection title="Report Branding">
          <p className="text-[13px] text-qa-muted m-0 mb-3">Configure the logo used in generated PDF reports. Use an internal HTTPS URL or a public asset path such as <span className="font-mono-qa">/assets/emirates-logo.png</span>.</p>
          <div className="grid grid-cols-2 gap-2.5 mb-2.5">
        ...
        <QaSection title="JIRA connections" className="lg:col-span-2">
          <p className="text-[13px] text-qa-muted m-0 mb-3">Add one JIRA connection per project. Select the project from the dropdown so DLM, ABC, and other project data stay separated in the main dashboard filter.</p>
        ...
        <QaSection title="Folder paths">
          <ul className="text-[13px] text-qa-muted m-0 p-0 list-none space-y-2 font-mono-qa"><li><span className="text-qa-ink">input/</span> — staged Excel exports</li><li><span className="text-qa-ink">output/</span> — dashboard-data.json, report.md</li><li><span className="text-qa-ink">config/</span> — fallback integrations.json</li></ul>
        </QaSection>
