      ...
      <div className="max-w-qa mx-auto px-8 pt-[26px] pb-[60px]">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-[34px] items-start">
          ...
          <article className="bg-white border border-qa-border min-h-[520px]">
            ...
            {isIdle && (
              <div className="flex flex-col items-center justify-center h-[520px] text-center px-10">
                ...
                <p className="text-[13.5px] text-qa-muted max-w-[380px] m-0">
                  Pick a report type and click <strong>Generate AI Report</strong>. Charts populate from your dataset; Claude writes the narrative when an API key is configured.
                </p>
              </div>
            )}
            {generating && (
            ...
            {isDone && (
              <div className="p-0">
                <div className="px-11 pt-7 pb-5 border-b-2 border-qa-ink flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="flex gap-4 font-mono-qa text-[10.5px] text-qa-muted-light uppercase tracking-wide flex-wrap">
                      ...
                      <span>·</span>
                      <span>{hasNarrative ? 'Generated by Claude' : 'Metrics only'}</span>
                      <span>·</span>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 border border-qa-ink bg-white text-qa-ink font-mono-qa text-[11px] font-semibold tracking-wide uppercase cursor-pointer disabled:opacity-50"
                  >
                    <Download size={14} />
                ...
                <div ref={exportRef} className="px-11 py-7 bg-white">
                  {chartData && (
                    <div className="mb-10 pb-8 border-b border-qa-border">
