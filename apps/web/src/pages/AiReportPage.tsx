        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-[34px] items-start">
          <aside className="lg:sticky lg:top-[18px]">
            <div className="bg-qa-ink text-[#F5F3ED] p-[22px]">
              ...
              <div className="flex items-center gap-1.5 mt-3.5"><span className="w-[7px] h-[7px] rounded-full shrink-0" style={{ background: status?.apiKeyConfigured ? QA.PASS : QA.BLOCKED }} /><span className="text-[10.5px] text-qa-muted-light">{status?.apiKeyConfigured ? 'Claude API key configured' : 'No API key — charts only'}</span></div>
            </div>
